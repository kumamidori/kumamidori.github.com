...
- <a href="https://twitter.com/ktz_alias/status/416426966330245120" target="_blank">たとえばデータベース接続。開発用、単体テスト用、結合テスト用などで使い分けようとすると、接続先を動的に解決する必要が出てきます。この用途にはDIが適しているでしょう。</a>
